    ...
    >
      ...
      <LegalSection title="2. How We Use Your Information">
        <ul className="ml-5 list-disc space-y-2">
          ...
          <li><strong>Communication:</strong> Send event updates, confirmations, occasional marketing offers, and important notices via SMS/email from the specific event host you opted in to. Messages are sent by Coucou on behalf of the event host using {brandName} as a messaging platform service provider when you provide explicit consent.</li>
      ...
      <LegalSection title="3. SMS and Communication Privacy">
        <ul className="ml-5 list-disc space-y-2">
          ...
          <li>SMS messages are sent by Coucou on behalf of the event host using {brandName} as a messaging platform service provider, and are delivered through Twilio, a SOC 2 compliant SMS infrastructure provider.</li>
          <li>We use obfuscated phone numbers for display purposes where full numbers are not required (e.g., ***-***-1234).</li>
      ...
      <LegalSection title="5. Third-Party Services">
        <ul className="ml-5 list-disc space-y-2">
          <li><strong>Clerk (Authentication):</strong> Manages user accounts and authentication securely.</li>
          <li><strong>Twilio (SMS Infrastructure):</strong> Provides SMS delivery infrastructure. Messages are sent by Coucou on behalf of the event host using {brandName} as the messaging platform, with Twilio handling the technical delivery.</li>
          <li><strong>Convex (Database):</strong> Secure, real-time database for application data.</li>
        </ul>
      </LegalSection>
