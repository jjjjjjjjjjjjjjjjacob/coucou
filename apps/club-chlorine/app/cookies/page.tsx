    ...
    >
      <LegalSection title="1. What Are Cookies?" rule={false}>
        <p>
          ...
          our site. They help us provide a better experience by remembering
          your preferences, analyzing how you use the platform, and improving
          our services.
        </p>
      </LegalSection>
      ...
      <LegalSection title="2. Types of Cookies We Use">
        ...
        <p style={{ color: "var(--tt-fg-dim)" }}>
          <strong>Retention:</strong> Session cookies are deleted when you
          close your browser. Persistent authentication cookies last up to 30
          days.
        </p>
        ...
        <ul className="ml-5 list-disc space-y-2">
          <li><strong>No product analytics cookies.</strong></li>
          <li><strong>No advertising cookies.</strong></li>
          <li><strong>No cross-site tracking.</strong></li>
          <li><strong>No third-party A/B testing cookies.</strong></li>
        </ul>
        ...
        <ul className="ml-5 list-disc space-y-2">
          ...
          <li><strong>Haptic Feedback:</strong> Store your haptic feedback preferences for mobile.</li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="3. Third-Party Cookies">
        <ul className="ml-5 list-disc space-y-2">
          <li>
            <strong>Clerk Authentication.</strong> Manages secure user
            authentication and session management.
            See <a href="https://clerk.com/privacy" className="underline" target="_blank" rel="noreferrer">clerk.com/privacy</a>.
          </li>
          <li>
            <strong>Convex Real-time Database.</strong> Enables real-time
            features and secure data sync.
            See <a href="https://convex.dev/privacy" className="underline" target="_blank" rel="noreferrer">convex.dev/privacy</a>.
          </li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="4. Local Storage and Similar Technologies">
        ...
        <ul className="ml-5 list-disc space-y-2">
          <li><strong>Local Storage</strong> for user preferences and application state.</li>
          <li><strong>Session Storage</strong> for the current browser session.</li>
          <li><strong>IndexedDB</strong> for offline functionality and caching.</li>
          <li><strong>Service Workers</strong> for offline features and push notifications.</li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="5. Managing Your Cookie Preferences">
        ...
        <p>
          Disabling essential cookies will prevent core features from working
          properly, including user authentication, event access, and RSVP
          functionality.
        </p>
      </LegalSection>
      ...
      <LegalSection title="7. Mobile Apps and Progressive Web Apps">
        <p>
          If you access {brandName} through a mobile app or as a Progressive
          Web App, similar data storage technologies may be used to provide
          the best possible experience. You can manage these through your
      ...
      <LegalSection title="8. Updates to This Policy">
        <p>
          ...
          or legal requirements. We will post any changes here and update the
