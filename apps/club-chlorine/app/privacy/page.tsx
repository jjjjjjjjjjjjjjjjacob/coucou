  ...
  return (
    ...
    >
      ...
      <LegalSection title="3. Mobile Messaging Privacy">
        <p>
          When you use Club Chlorine&apos;s SMS features, we may collect your mobile number, SMS
          ...
          information to operate the Club Chlorine messaging program, deliver requested event
        ...
        <p>
          ...
          with third parties or affiliates for marketing or promotional purposes. Club Chlorine does
          not sell, rent, purchase, or use this information for third-party marketing or lead
          generation.
        </p>
        <p>
        ...
        <p>
          Club Chlorine retains consent, opt-out, delivery, and messaging records for as long as
