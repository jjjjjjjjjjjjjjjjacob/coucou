...
// Chlorine's pool-blue-on-white aesthetic. Form labels match the uppercase
...
const accountSettingsAppearance: Appearance = {
  elements: {
    ...
    headerTitle:
      "text-xl tracking-[0.01em] uppercase text-primary",
    ...
    profileSectionTitle:
      "text-[11px] uppercase tracking-[0.12em] font-medium text-primary",
    ...
    accordionTriggerButton:
      "border-none rounded-none bg-transparent text-primary",
  },
  variables: {
    fontFamily:
      'var(--font-geist-mono), "Geist Mono", "JetBrains Mono", ui-monospace, monospace',
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col space-y-8">
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-sm text-primary/70">
            Manage your sign-in methods, contact information, and security
            preferences.
          </p>
        </div>
