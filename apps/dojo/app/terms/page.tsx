          ...
          <div className="bg-card rounded-lg p-8 border shadow-sm space-y-8">
            <section>
              ...
              <p className="mt-3 font-semibold text-primary">
                SMS notifications are optional. When you affirmatively select the SMS opt-in for a specific event, you consent to receive messages from that event&apos;s host (for example, Party Nights Presents). Messages are sent by Coucou on behalf of the event host using Dojo Pomodoro as a messaging platform service provider. You may withhold or withdraw that consent at any time.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3">
                <p>
                  Coucou operates Dojo Pomodoro as an Independent Software Vendor (&ldquo;ISV&rdquo;) that supplies communication tooling, event management workflows, and SMS delivery infrastructure. Coucou does not author or control the messaging content that event attendees receive.
                </p>
                <p>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li><span className="font-semibold text-primary">Coucou (ISV) obligations:</span> Capture SMS consent records, transmit opt-out commands to the End Business, and deliver messages securely via Twilio while enforcing compliance safeguards.</li>
            ...
            <section>
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-lg border border-orange-200 dark:border-orange-800">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>SMS messages are transmitted by Coucou on behalf of the event host (for example, Party Nights Presents or Max, Orson, Danya) using Dojo Pomodoro as a messaging platform service provider</li>
