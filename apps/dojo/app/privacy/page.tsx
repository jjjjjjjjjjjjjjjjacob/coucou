            ...
            <section>
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-lg border border-orange-200 dark:border-orange-800">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>SMS messages are sent by Coucou on behalf of the event host (for example, Party Nights Presents or Max, Orson, Danya) using Dojo Pomodoro as a messaging platform service provider, and are delivered through Twilio, a SOC 2 compliant SMS infrastructure provider</li>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">Provides SMS delivery infrastructure. Messages are sent by Coucou on behalf of the event host using Dojo Pomodoro as the messaging platform, with Twilio handling the technical delivery</p>
                </div>
                <div className="border rounded-lg p-4">
