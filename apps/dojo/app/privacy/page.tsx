        ...
        <div className="prose prose-gray max-w-none dark:prose-invert">
          <div className="bg-card rounded-lg p-8 border shadow-sm space-y-8">
            <section>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border border-blue-200 dark:border-blue-800 mb-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong>Profile Data:</strong> Custom fields for events, preferences, and
                    metadata
                  </li>
                  <li>
                    <strong>Authentication Data:</strong> Managed securely through Clerk
              ...
              <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg border border-green-200 dark:border-green-800">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong>Operational Diagnostics:</strong> Error details and performance signals
                    used to keep the platform reliable
                  </li>
                  <li>
                    <strong>Security Signals:</strong> Activity patterns reviewed to detect abuse
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Service Delivery:</strong> Process RSVPs, manage events, send
                  notifications
                </li>
                <li>
                  <strong>Communication:</strong> Send event updates, confirmations, occasional
                  marketing offers, and important notices via SMS/email from the specific event host
                  you opted in to (e.g., Party Nights Presents). Messages are sent by Coucou on
                  behalf of the event host using Dojo Pomodoro as a messaging platform service
                  provider when you provide explicit consent
                </li>
                <li>
                ...
                <li>
                  <strong>Security:</strong> Detect fraud, prevent abuse, and maintain platform
                  security
                </li>
                <li>
                  <strong>Legal Compliance:</strong> Meet regulatory requirements and respond to
                  legal requests
                </li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-primary mb-4">
                3. SMS and Communication Privacy
              </h2>
              <div className="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-lg border border-orange-200 dark:border-orange-800">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    SMS messages are sent by Coucou on behalf of the event host (for example, Party
                    Nights Presents or Max, Orson, Danya) using Dojo Pomodoro as a messaging
                    platform service provider, and are delivered through Twilio, a SOC 2 compliant
                    SMS infrastructure provider
                  </li>
                  <li>
                    We use obfuscated phone numbers for display purposes where full numbers are not
                    required (e.g., ***-***-1234)
                  </li>
                  ...
                  <li>
                    SMS consent is logged with the timestamp and originating IP address for
                    compliance purposes
                  </li>
                  <li>SMS consent can be withdrawn at any time by texting STOP</li>
                  <li>
                    You can manage SMS preferences from your RSVP status page or profile at any time
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Provides SMS delivery infrastructure. Messages are sent by Coucou on behalf of
                    the event host using Dojo Pomodoro as the messaging platform, with Twilio
                    handling the technical delivery
                  </p>
                </div>
                <div className="border rounded-lg p-4">
                  <h4 className="font-semibold text-primary">Convex (Database)</h4>
                  <p className="text-sm text-muted-foreground">
                    Secure, real-time database for application data
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>SMS Data:</strong> Phone numbers are deleted when consent is withdrawn,
                  while minimal consent records (timestamp, IP address, and the event host
                  associated with consent) are retained for legal compliance
                </li>
                <li>
                  <strong>Operational Diagnostics:</strong> Retained only as long as needed to
                  investigate issues, prevent abuse, and maintain reliability
                </li>
                <li>
                  <strong>Legal Requirements:</strong> Some data may be retained longer for
                  compliance purposes
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <div className="bg-gray-50 dark:bg-gray-900/20 p-6 rounded-lg border">
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <strong>Data Protection:</strong> Contact us through the platform for
