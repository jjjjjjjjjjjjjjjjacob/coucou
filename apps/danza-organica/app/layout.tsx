...
// Geist is the danza preset's display + text face (the Dojo Pomodoro
// treatment recolored teal/black). Loading it via next/font/google avoids
// a runtime FOUT and exposes the `--font-geist-sans` variable consumed by
// the preset's font stacks.
...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      // brand teal. Browsers that don't support SVG favicons fall through to
      // the rasterised PNG fallbacks below.
      { url: danzaOrganicaIconPaths.svg, type: "image/svg+xml" },
      {
    ...
    apple: danzaOrganicaIconPaths.appleTouchIcon,
    shortcut: danzaOrganicaIconPaths.faviconIco,
  },
  manifest: danzaOrganicaIconPaths.manifest,
};
