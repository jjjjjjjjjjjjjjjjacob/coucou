...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      {
        source: "/admin",
        destination: `${coucouBaseUrl}/workspaces/danza-organica/dashboard`,
        permanent: false,
      },
      {
        source: "/admin/:path*",
        destination: `${coucouBaseUrl}/workspaces/danza-organica/dashboard/:path*`,
        permanent: false,
      },
      {
        source: "/host",
      ...
      {
        source: "/door",
        destination: `${coucouBaseUrl}/workspaces/danza-organica/dashboard/door`,
        permanent: false,
      },
      {
        source: "/door/:path*",
        destination: `${coucouBaseUrl}/workspaces/danza-organica/dashboard/door/:path*`,
        permanent: false,
      },
    ];
  },
