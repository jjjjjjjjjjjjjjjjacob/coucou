...
export type StaffBootstrap = FunctionReturnType<
  typeof api.mobileStaff.getBootstrap
>;
export type StaffWorkspace = StaffBootstrap["workspaces"][number];
export type StaffEventSummary = FunctionReturnType<
  typeof api.mobileStaff.listEvents
>[number];
export type StaffGuestPage = FunctionReturnType<
  typeof api.mobileStaff.listGuests
>;
export type StaffGuestSummary = StaffGuestPage["page"][number];
export type StaffScanOutcome = FunctionReturnType<
  typeof api.mobileStaff.scanTicket
>;
