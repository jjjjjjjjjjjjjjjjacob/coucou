...
export function normalizeQrCodeHexColor(value: string | null | undefined): string | undefined {
...
export function resolveQrCodeColors(source: QrCodeColorSource | null | undefined): {
  backgroundColor: string;
  foregroundColor: string;
} {
  return {
    backgroundColor:
      normalizeQrCodeHexColor(source?.backgroundColor) ?? DEFAULT_QR_CODE_BACKGROUND_COLOR,
    foregroundColor:
      normalizeQrCodeHexColor(source?.foregroundColor) ?? DEFAULT_QR_CODE_FOREGROUND_COLOR,
  };
}
